...
def main():
    ...
    parser.add_argument('--column_x', type=int, default=-2, help="Column index for the first variable (default: -2).")
    ...
    parser.add_argument('--method', type=str, default='pearson', choices=['pearson', 'spearman'],
