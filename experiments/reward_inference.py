...
def main(
    ...
    **kwargs,
    ...
    def calculate_log_probs(labels, logits):
    ...
    def inference_new(
        ...
        for step, batch in enumerate(dataloader):
            ...
            with torch.no_grad():
                ...
                log_prob, norm_log_prob = calculate_log_probs(labels, logits)
                ...
                batch_score = ["{:.6f}\t{:.6f}\t{:.6f}".format(logp.item(), norm_logp.item(), float(score))
                               for logp, norm_logp, score in zip(log_prob, norm_log_prob, scores)]
    ...
    for lang_pair in lang_pairs:
        ...
        results = inference_new(test_dataloader)
